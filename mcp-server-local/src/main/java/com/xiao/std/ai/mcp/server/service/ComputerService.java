package com.xiao.std.ai.mcp.server.service;

import com.xiao.std.ai.mcp.server.model.ComputerFunctionRequest;
import com.xiao.std.ai.mcp.server.model.ComputerFunctionResponse;
...
public class ComputerService {
    @Tool(name = "queryComputerConfig", description = "获取电脑配置")
    public ComputerFunctionResponse queryComputerConfig(ComputerFunctionRequest request) {
